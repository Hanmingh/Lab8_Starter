...
describe('Basic user flow for Website', () => {
  ...
  it('Checking number of items in cart on screen', async () => {
    ...
    let innertxt = await cart_count.getProperty('innerText');
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    let cart_count = await page.$('#cart-count');
    let cart_txt = await cart_count.getProperty('innerText');
    expect(cart_txt['_remoteObject'].value).toBe('20');
  }, 10000);
  ...
  it('Checking number of items in cart on screen after removing from cart', async () => {
    ...
    let cart_count = await page.$('#cart-count');
    let cart_txt = await cart_count.getProperty('innerText');
    expect(cart_txt['_remoteObject'].value).toBe('0');
  }, 10000);
